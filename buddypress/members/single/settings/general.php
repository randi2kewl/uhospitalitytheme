...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>" method="post" class="standard-form" id="settings-form">
	...
	<?php if ( !is_super_admin() ) : ?>
		...
		<label for="pwd"><?php _e( 'Current Password <span>(required to change current password)</span>', 'buddypress' ); ?></label>
...
<!--	<label for="email">--><?php //_e( 'Account Email', 'buddypress' ); ?><!--</label>-->
	<input type="hidden" name="email" id="email" value="<?php echo bp_get_displayed_user_email(); ?>" class="settings-input" <?php bp_form_field_attributes( 'email' ); ?>/>
